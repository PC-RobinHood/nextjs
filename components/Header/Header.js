...
import headerLinksStyle from "../../assets/jss/app/components/headerLinkStyle"
    ...
    <header className="header">
      <GridContainer className={classes.logo}>
        <GridItem className={classes.logo}>
          <Link to="/">
            <img src="../../assets/img/atom.jpg" className={classes.logo}></img>
            <img src="" className={classes.logo}></img>
          </Link>
        </GridItem>
      </GridContainer>
